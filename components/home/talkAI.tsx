...
const TalkAI = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm lg:text-xl text-gray-500 tracking-tighter">
        ...
        <div className="w-full mt-2 space-y-5">
          ...
          >
            <textarea
              ...
              rows={5}
              className="resize-none w-full border-2 rounded-lg border-slate-200 focus:ring-2 focus:ring-offset-2 focus:ring-green-500 focus:outline-none p-2 text-sm lg:text-xl transition-all"
