import TermsMenu from "@/components/footer/termsMenu";
import NavBar from "@/components/navBar";

const PrivacyTerms = () => {
  return (
    <NavBar title="개인정보처리방침" hasTabBar pageBack>
      <div className="w-full flex flex-col space-y-5 px-2 min-h-screen mb-5">
        <TermsMenu />
        <div className="flex flex-col space-y-4">
          <div className="text-sm flex flex-col space-y-2">
            <p>
              마인드스케일링은 개인정보보호법에 따라 이용자의 개인정보 보호 및
              권익을 보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할
              수 있도록 다음과 같은 처리방침을 두고 있습니다.
            </p>
            <p>
              마인드스케일링은 개인정보처리방침을 개정하는 경우 웹사이트
              공지사항을 통하여 공지할 것입니다.
            </p>
          ...
          <div className="text-sm flex flex-col space-y-2">
            <p>
              마인드스케일링은 개인정보를 다음의 목적을 위해 처리합니다. 처리한
          ...
          <div className="text-sm flex flex-col space-y-2 list-disc indent-2">
            <li>
              개인정보 항목: 고유식별 ID, 사용자명, 이메일, 회원이 등록한 사진,
              가입일, 계정 업데이트일
            </li>
            <li>수집방법: 홈페이지</li>
            <li>보유근거: 개인정보처리방침</li>
          ...
          <div className="text-sm flex flex-col space-y-2">
            <p>
              ① 마인드스케일링은 법령에 따른 개인정보 보유·이용기간 또는
            ...
            <p>
              웹사이트 회원가입 및 서비스 제공과 관련한 개인정보를 수집·이용에
              관한 동의일로부터 2년까지 위 이용목적을 위하여 보유·이용됩니다.
            </p>
          ...
          <div className="text-sm flex flex-col space-y-2">
            <p>
              ① 마인드스케일링은 정보주체의 동의, 법률의 특별한 규정 등
          ...
          <div className="text-sm flex flex-col space-y-2">
            ...
            <p>
              ① 정보주체는 마인드스케일링에 대해 언제든지 다음 각 호의 개인정보
            ...
            <p>
              ② 제1항에 따른 권리 행사는 마인드스케일링에 대해 전자우편을 통해
              하실 수 있으며, 마인드스케일링은 이에 대해 지체없이
              조치하겠습니다.
            </p>
            <p>
              ③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한
              경우에는 마인드스케일링은 정정 또는 삭제를 완료할 때까지
          ...
          <div className="text-sm flex flex-col space-y-2">
            <p>
              마인드스케일링은 원칙적으로 개인정보 처리목적이 달성된 경우에는
              지체없이 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과
              같습니다.
            </p>
            <h3 className="font-semibold text-base">가. 파기절차</h3>
            <p>
              이용자가 제공에 동의한 정보는 목적 달성 후 별도의 DB에 옮겨져 내부
              방침 및 기타 법령에 따라 일정기간 저장된 후 혹은 즉시 파기됩니다.
              이때, DB에 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 다른
              목적으로 이용되지 않습니다.
            </p>
            ...
            <p>
              ...
              해당 서비스의 폐지, 웹서비스의 종료 등 그 개인정보가 불필요하게
          ...
          <div className="text-sm flex flex-col space-y-2">
            <p>
              마인드스케일링은 개인정보보호법 제29조에 따라 다음과 같이 안정성
              확보에 필요한 조치를 하고 있습니다.
            </p>
            <p>① 개인정보에 대한 접근 제한</p>
            <p>② 개인정보의 암호화</p>
          ...
          <div className="text-sm">
            귀하께서는 서비스를 이용하시며 발생하는 모든 개인정보보호 관련
            민원을 개인정보관리책임자에게 신고하실 수 있습니다. 마인드스케일링은
