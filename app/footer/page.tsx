...
const Footer = () => {
  return (
    <div className="w-full border-t flex flex-col lg:justify-around lg:flex-row space-y-5 px-6 pt-8 pb-28 bg-slate-100 mb-8 xl:mb-0 dark:bg-slate-600 lg:text-lg">
      ...
      <div className="flex flex-col space-y-4">
        ...
        <div className="flex items-center space-x-10 text-sm lg:text-base font-semibold">
